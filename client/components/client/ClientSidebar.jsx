                    ...
                    {isSideBarOpen && (
                        <div className="flex items-center space-x-2">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-300">Shopping Dashboard</p>
                            </div>
                        </div>
                    )}
                </div>
                        ...
                        return (
                            <div key={item.key} className="relative">
                                ...
                                >
                                    ...
                                    {isActive && (
                                        <div className="absolute left-0 top-1/2 transform -translate-y-1/2 w-1 h-8 bg-green-400 rounded-r-full" />
                                    )}
                                </button>
                            </div>
                        );
